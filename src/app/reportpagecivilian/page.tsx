...
import React, { useEffect, useMemo, useRef, useState } from "react"
    ...
    return (
        ...
        <div className="relative w-[794px] min-h-[1123px] bg-white print:w-[210mm] print:h-[297mm]">
            ...
            {/* MANHOURS + LOCATION (side-by-side with divider) */}
            <div className="grid grid-cols-[220px_12px_1fr_220px_12px_1fr] thin-l thin-r thin-b avoid">
                {/* MANHOURS (left) */}
                <div className="label thin-r thin-b">MANHOURS</div>
                <div className="colon thin-r thin-b">:</div>
            ...
            <div className="px-2 pb-2 text-[10px] text-gray-700 flex items-center justify-between avoid">
                <div>G7A-SOP-NDT(CIV) R2, Issued date 13 NOV 2024</div>
                <div>Page 1 of 2</div>
            </div>
            </form>
        </div>
        ...
        <button
            type="button"
            onClick={() => (window.location.href = "/reportpageciviliantwo?form=1")}
    ...
    /* ---------------- Main Page ---------------- */
    export default function ReportPageCivilian() {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-4">
                ...
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem className="hidden md:block">
                    <BreadcrumbLink href="/reportpagecivilian">Report Form Civilian</BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
                </Breadcrumb>
            </div>
