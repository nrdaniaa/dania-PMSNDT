...
import React, { useEffect, useRef, useState } from "react"
    ...
    /* ============================== Page ============================== */
    export default function ReportPageCivilianTwo() {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-4">
                ...
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem className="hidden md:block">
                    <BreadcrumbLink href="/reportpagecivilian">Report Form Civilian 1</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem className="hidden md:block">
                    <BreadcrumbLink href="/reportpageciviliantwo">Report Form Civilian 2</BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
                </Breadcrumb>
            </div>
